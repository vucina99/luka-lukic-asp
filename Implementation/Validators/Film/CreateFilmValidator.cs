...
namespace Implementation.Validators.Film
{
    ...
    public class CreateFilmValidator : AbstractValidator<CreateFilmApiDto>
    {
        private readonly FilmContext _context;

        public CreateFilmValidator(FilmContext context)
        {
            _context = context;
            ...
            RuleFor(x => x.FilmCategoryIds).Cascade(CascadeMode.Stop).NotEmpty().WithMessage("FilmCategoryIds parametar must have a value")
